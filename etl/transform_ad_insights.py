...
def transform_ad_insights(
    ...
    print(
        "🔄 [TRANSFORM] Transforming Facebook Ads ad insights with "
        f"{len(df)} row(s)..."
    )
    ...
    if df.empty:
        ...
        print(
            "⚠️ [TRANSFORM] Failed to transform Facebook Ads ad insights due to no input DataFrame then transformation will be suspended."
        )
