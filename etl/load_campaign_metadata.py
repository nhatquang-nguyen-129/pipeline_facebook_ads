...
def load_campaign_metadata(
    *,
    ...
    if df.empty:
        ...
        print(
            "⚠️ [LOADER] Failed to load Facebook Ads campaign metadata due to no input DataFrame then loading will be suspended."
        )
        
        return

    print(
        "🔄 [LOADER] Loading Facebook Ads campaign metadata with "
