...
def mart_campaign_supplier() -> None:
    ...
    try:       
        ...
        mart_section_succeeded["1.2.5. Get supplier name list from Google Sheets"] = False
        mart_section_failed.append("1.2.5. Get supplier name list from Google Sheets")
