...
# 1.2. Build materialized table for Facebook festival campaign spending by union all staging tables
...
# 2.2. Build materialzed table for Facebook festival campaign performance by union all staging tables
